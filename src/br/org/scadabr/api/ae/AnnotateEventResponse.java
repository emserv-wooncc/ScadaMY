...
public class AnnotateEventResponse  implements java.io.Serializable {
    ...
    private br.org.scadamy.api.vo.EventMessage[] eventMessagesList;
    ...
    public AnnotateEventResponse(
           ...
           br.org.scadamy.api.vo.EventMessage[] eventMessagesList,
     ...
     */
    public br.org.scadamy.api.vo.EventMessage[] getEventMessagesList() {
        return eventMessagesList;
    }
     ...
     */
    public void setEventMessagesList(br.org.scadamy.api.vo.EventMessage[] eventMessagesList) {
        this.eventMessagesList = eventMessagesList;
    }

    public br.org.scadamy.api.vo.EventMessage getEventMessagesList(int i) {
        return this.eventMessagesList[i];
    }

    public void setEventMessagesList(int i, br.org.scadamy.api.vo.EventMessage _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ae.api.scadamy.org.br", ">AnnotateEventResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ae.api.scadamy.org.br", "eventMessagesList"));
