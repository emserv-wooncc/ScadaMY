...
public class BrowseEventsResponse  implements java.io.Serializable {
    ...
    private br.org.scadamy.api.vo.EventDefinition[] eventsList;
    ...
    public BrowseEventsResponse(
           ...
           br.org.scadamy.api.vo.EventDefinition[] eventsList,
     ...
     * @return eventsList
     */
    public br.org.scadamy.api.vo.EventDefinition[] getEventsList() {
        return eventsList;
    }
     ...
     * @param eventsList
     */
    public void setEventsList(br.org.scadamy.api.vo.EventDefinition[] eventsList) {
        this.eventsList = eventsList;
    }

    public br.org.scadamy.api.vo.EventDefinition getEventsList(int i) {
        return this.eventsList[i];
    }

    public void setEventsList(int i, br.org.scadamy.api.vo.EventDefinition _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ae.api.scadamy.org.br", ">BrowseEventsResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://vo.api.scadamy.org.br", "EventDefinition"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
